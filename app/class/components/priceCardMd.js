...
const PriceCardMd = ({
  ...
  return (
    <div
      className={`bg-white border border-gray-200 rounded-2xl p-3 sm:px-5 sm:py-6 shadow-xl w-full max-w-md mx-auto ${className}`}
    >
      {/* Event Tags */}
      ...
      <button className="w-full bg-[#00EA9C] text-black font-bold rounded-xl hover:bg-[#00c584] transform transition-all duration-300 shadow-lg focus:ring-4 focus:ring-[#00EA9C]/50 px-6 py-3.5 text-sm sm:text-base">
        Book Tickets
      </button>
    </div>
  );
